...
#if !defined(ARDUINO) && !defined(ESP_PLATFORM) && !defined(PICO_BOARD) && \
    !defined(__linux__) && !defined(_WIN32) && !defined(_WIN64)
...
/**
  ...
  */
void MINBASECLI::setup(void* iface)
{
    this->iface = iface;
...
#endif /* !ARDUINO !ESP_PLATFORM !PICO_BOARD !__linux__ !_WIN32 && !_WIN64 */
